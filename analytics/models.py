...
class Analytics(models.Model):
    ...
    VALUE_TYPE_CHOICES = [(P, "Percentage"), (N, "Numerical")]
    ...
    PERIOD_TYPE_CHOICES = [(D, "Daily"), (W, "Weekly"), (M, "Monthly"), (S, "Session")]
    ...
    value_type = models.CharField(
        choices=VALUE_TYPE_CHOICES, null=False, blank=False, default="Session"
    )
