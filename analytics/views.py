...
def metrics_display(request):
    ...
    return render(
        request,
        "analytics/analytics_display.html",
...
def avg_macros_all_time_display(request):
    ...
    return render(
        request,
        "analytics/all_time_macros_display.html",
        {"initial_metrics": intial_metrics},
    )
...
def avg_macros_weekly_display(request):
    ...
    return render(
        request,
        "analytics/weekly_macros_display.html",
        {"initial_metrics": intial_metrics},
    )
...
def avg_macros_monthly_display(request):
    ...
    return render(
        request,
        "analytics/monthly_macros_display.html",
        {"initial_metrics": intial_metrics},
    )
